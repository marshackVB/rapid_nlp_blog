...
# MAGIC 
# MAGIC  - [per_device_train_batch_size](https://huggingface.co/docs/transformers/perf_train_gpu_one#vanilla-training): Experiment with  16, 32, 64 and 128.
# MAGIC  - [fp16](https://huggingface.co/docs/transformers/perf_train_gpu_one#fp16-training)  
# MAGIC  - [gradient_accumulation_steps](https://huggingface.co/docs/transformers/perf_train_gpu_one#gradient-accumulation) 
# MAGIC  - [group_by_length](#https://huggingface.co/docs/transformers/v4.21.2/en/main_classes/trainer#transformers.TrainingArguments.group_by_length)
# MAGIC 
